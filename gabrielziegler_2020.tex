...
\section{1D Direct vs Indirect L1-Minimization}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{1d_signal_plot}
    \caption{First 20 1-d signals}\label{visina8}
\end{figure}
...
The filtered images are then composed to one single image containing the highest gain each filter could provide given a single pixel in the image\cite{miosso_compressive_2009}.
