...
\begin{figure}[H]
    \centering
    \includegraphics[width=150mm,scale=0.7]{kspace-coil.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=150mm,scale=0.7]{sampling-trajectories}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=150mm,scale=0.7]{mlp-architecture}
...
\section{1D Compressed Sensing Reconstruction}
...
In order to test the usage of \ac{GAN}s for data generation and in the future use it along with \textit{prior information} for \ac{CS} systems, I have developed a \ac{GAN} capable of generating handwritten digits from 0 to 9 using the well known MNIST dataset.
...
For the preliminary tests with \ac{GAN}s, I have developed a

this step will be developed throughout TCC2.
%---}}}
