...
\begin{figure}[H]
    ...
    \caption{Generator network architecture for a 3-d image\cite{radford_unsupervised_2016}}\label{visina8}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Discriminator network architecture 3-d image\cite{radford_unsupervised_2016}}\label{visina8}
\end{figure}
%---}}}
...
The trade-off really starts making a big difference with L size around 200 samples, which is close to 80\% of the data present in the signal to be reconstructed.
