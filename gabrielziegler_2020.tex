...
Additionaly, we propose a novel non-deterministic approach by proposing different covariance matrices for different regions in the image.
...
By taking this into account, we propose four levels of variance by identifying portions of \textit{high}, \textit{medium}, \textit{low} and \textit{close-to-zero} movement.
...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.4\textwidth}
    ...
    \caption{Manual segmentation. Pink, red and yellow regions with most perceived movement respectively.}
  \end{minipage}
  \begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{gaussian_heatmap.png}
    \caption{The corresponding prior information matrix with adjusted covariance matrices.}
  \end{minipage}
\end{figure}


\begin{figure}[H]
    \includegraphics[width=0.5\textwidth]{2d_weights.pdf}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.5\textwidth]{weight_surf.pdf}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.5\textwidth]{weighted_phi_surf.pdf}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.5\textwidth]{2d_norm_weighted_phi.pdf}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.5\textwidth]{2d_weighted_phi.pdf}
\end{figure}
   

Evidently, this implies that this task could gain a lot from a specialized image segmentation system or even a non-movement region detection system, which are more elaborated in future steps section.
