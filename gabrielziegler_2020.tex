...
This thesis' goal is to develop an improved \ac{MR} prior information algorithm based on \ac{GAN} the usage of motion information for dynamic \ac{MRI} and support position similarity for multi-frame \ac{MRI} scans. 
The expected outcome of this algorithm is to improve reconstruction also in runtime, hence improving quality in reconstructed \ac{MRI} and decreasing necessity for larger sampling allowing for faster exams.
