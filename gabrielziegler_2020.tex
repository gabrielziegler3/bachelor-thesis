...
The prior information step consists of creating $f$ 1-D arrays with the $\Phi$ positions of non-zero elements from the filtered images generated in the previous step.
As those filtered images are composed of
These $\Phi$ positions are then multiplied by a $\tau$ factor of 10 at each iteration.
This is the deterministic approach for prior information leverage and
