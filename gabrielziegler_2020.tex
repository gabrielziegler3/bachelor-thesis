...
The original \ac{GAN} paper presents a loss function called \textit{minmax}~\cite{goodfellow_generative_2014}, that is described as.
...
\subsection{\ac{Stochastic Gradient Descent}}
