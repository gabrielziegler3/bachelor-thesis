...
\ac{CS} theory aims to provide accurate reconstruction of unknown sparse signals from underdetermined linear measurements.
...
In MRI, the so-called \textit{k-space} is a sparse representation of the image to be reconstructed and when it is undersampled, the Nyquist criterion is violated~\cite{lustig_sparse_2007}.
...
\subsection{Reconstructing using the L1 Regularization}
