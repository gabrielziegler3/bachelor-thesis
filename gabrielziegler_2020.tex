...
For this experiment, we decided to use a radial undersampling mask with 60 lines, concentrating most of the measurements in the low frequency regions.
...
These images represent the different strategies we took for \ac{MRI} reconstruting and are hard to distinguish and perceive actual gain in terms of image quality, thus we should also analyse the metrics from our dynamic \ac{MR} reconstrution.
